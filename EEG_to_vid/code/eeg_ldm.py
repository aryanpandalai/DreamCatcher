...
if __name__ == '__main__':
    ...
    config.root_path = '/content/DreamDiffusion'
    ...
    config.pretrain_mbm_path = os.path.join(config.root_path, 'eeg_pretain', 'checkpoint.pth')
    config.pretrain_gm_path = os.path.join(config.root_path, 'pretrains')  # adjust if necessary
    ...
    config.logger = None  # or initialize your logger as needed
